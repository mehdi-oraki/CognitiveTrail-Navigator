...
- Analysis: `data/analyze.html` (interactive charts of top subdomains, TLDs, and day-of-week usage; includes checkbox selector to customize which subdomains appear in the graphs).
